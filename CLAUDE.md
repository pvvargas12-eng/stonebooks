...
- NJ sales tax: 6.625%
- Sprint naming convention: `3o → 3p → 3q → 3r → 3r.2 → 3s → 3s.3 → 3u → 3v → 3w → 3x → S1 → M2-P1 → M2-P2 → M2-P2.1 → M2-P3 → M2-P4 (M2 COMPLETE) → L2-P1 → L2-P2 → L2-P3`
...
**Phase 4 next:** HTML/CSS preview replaces the SVG `LivePreview` + side-confirmation banner surfaces `inscription.sideToConfirm` on the order-summary surface + delete `LivePreview`/`PreviewPanel` SVG.
