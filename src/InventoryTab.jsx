    ...
    <div className="sb-page sb-page-wide">
      ...
      <div className="sb-page-head inv-head">
        <div>
          ...
          <h1 className="sb-page-title">{view === 'matches' ? 'Smart Matches' : view === 'needs' ? 'Needs Ordering' : view === 'yard' ? 'Yard' : view === 'procurement' ? 'Procurement' : view === 'receiving' ? 'Receiving' : view === 'reconcile' ? 'Reconcile' : view === 'photos' ? 'Photos & Etching' : view === 'suppliers' ? 'Suppliers' : 'Dashboard'}</h1>
        </div>
        <div className="inv-head-actions">
          <div className="inv-seg">
            ...
            <button type="button" className={`inv-seg-btn${view === 'reconcile' ? ' on' : ''}`} onClick={() => setView('reconcile')}>Reconcile</button>
      ...
      {view === 'reconcile' && <InventoryReconcile onOpenOrder={onOpenOrder} />}
