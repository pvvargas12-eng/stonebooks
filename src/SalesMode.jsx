...
// Phase 1 — spec catalog lives in lib/monumentCatalog (dependency-free). These
...
// ftIn, SHAPES, TOP_SHAPES, SIDES_OPTIONS, BASE_SIDES_OPTIONS,
// POLISH_TO_SIDES_DEFAULT, POLISH_LEVELS, BASE_SIZES, BASE_HEIGHTS
// → moved to lib/monumentCatalog (Phase 1); imported + re-exported above.
...
// GRANITE_COLORS → moved to lib/monumentCatalog (Phase 1); imported + re-exported above.
...
// INSCRIPTION AUTO-TEXT — generateCarveText now lives in src/lib/carveText.js
// (shared with the Quick Order form, imported at the top of this file). One
// source of truth, no duplicate copy that can drift.
...
// DIE_TOP_TRADE, dimsFromWDT, dieSize3, buildDieSpec → moved to lib/monumentCatalog
// (Phase 1). buildDieSpec + dimsFromWDT are imported + re-exported above.
