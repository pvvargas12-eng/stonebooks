...
--   • ~36 work_batch_jobs stop links (stop_order on trips, NULL on shop blocks,
...
-- ─────────────────────────────────────────────────────────────────────────────
-- STEP 3 — Work batch jobs (~36 stop links)
-- ─────────────────────────────────────────────────────────────────────────────
...
INSERT INTO work_batch_jobs (
  ...
  -- (e04→d18 removed: DEMO-018 parked SETTING-ready, unbatched)
  ...
  -- (e07→d13 removed: DEMO-013 parked BLASTING-ready, unbatched)
  ...
  -- (e11→d18 removed: DEMO-018 parked SETTING-ready, unbatched)
  ...
  -- (e15→d13 removed: DEMO-013 parked BLASTING-ready, unbatched)
  ...
  -- (e16→d21 removed: DEMO-021 parked FOUNDATION_TRIP-ready, unbatched)
  ...
  -- (e19→d23 removed: DEMO-023 parked SETTING-ready, unbatched)
